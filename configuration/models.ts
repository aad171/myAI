...
export const INTENTION_MODEL: string = "ft:gpt-4o-2024-08-06:default-project:run-5:B8ALN2db";
export const INTENTION_TEMPERATURE: number = 0.7;

export const RANDOM_RESPONSE_PROVIDER: ProviderName = "openai";
export const RANDOM_RESPONSE_MODEL: string = "ft:gpt-4o-2024-08-06:default-project:run-5:B8ALN2db";
export const RANDOM_RESPONSE_TEMPERATURE: number = 0.7;

export const HOSTILE_RESPONSE_PROVIDER: ProviderName = "openai";
export const HOSTILE_RESPONSE_MODEL: string = "ft:gpt-4o-2024-08-06:default-project:run-5:B8ALN2db";

...
export const CHAT_HEADER: string = `CreditCompanion`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Aadit M @ UNC`;
export const CLEAR_BUTTON_TEXT: string = `New Conversation`;
export const PAGE_TITLE: string = `CreditCompanion`;
